    ...
    return (
      ...
      >
          <div className="galleryItem">
            <img src={hardCodedReviews[0].profile_photo_url} alt="text" className="galleryItemImage"/>
            <p className="galleryItemName">{hardCodedReviews[0].author_name}</p>
            <p className="galleryItemReview">{hardCodedReviews[0].text}</p>
          </div>
          <div className="galleryItem">
            <img src={hardCodedReviews[1].profile_photo_url} alt="text" className="galleryItemImage"/>
            <p className="galleryItemName">{hardCodedReviews[1].author_name}</p>
            <p className="galleryItemReview">{hardCodedReviews[1].text}</p>
          </div>
          <div className="galleryItem">
            <img src={hardCodedReviews[2].profile_photo_url} alt="text" className="galleryItemImage"/>
            <p className="galleryItemName">{hardCodedReviews[2].author_name}</p>
            <p className="galleryItemReview">{hardCodedReviews[2].text}</p>
          </div>
          <div className="galleryItem">
            <img src={hardCodedReviews[3].profile_photo_url} alt="text" className="galleryItemImage"/>
            <p className="galleryItemName">{hardCodedReviews[3].author_name}</p>
            <p className="galleryItemReview">{hardCodedReviews[3].text}</p>
          </div>
          <div className="galleryItem">
            <img src={hardCodedReviews[4].profile_photo_url} alt="text" className="galleryItemImage"/>
            <p className="galleryItemName">{hardCodedReviews[4].author_name}</p>
            <p className="galleryItemReview">{hardCodedReviews[4].text}</p>
        </div>
      </AliceCarousel>
    )
  }
