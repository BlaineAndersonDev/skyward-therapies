...
class Modalities extends Component {
  render() {
    return (
    <div id="modalitiesContainer" className="comContainer comImgContainer">
      <h1 id="modalitiesSectiontitle" className="comSectiontitle">Special Modalities</h1>
      <div className="comSectionContainer">

        <div className="comSubSectionContainer modalitiesSubSectionContainer">
          <h3 className="comSubSectionTitle modalitiesSubSectionTitle">Injury and Rehabilitation</h3>
        ...
        <div className="comSubSectionContainer modalitiesSubSectionContainer">
          <h3 className="comSubSectionTitle modalitiesSubSectionTitle">Rock and Unlock Therapy</h3>
        ...
        <div className="comSubSectionContainer modalitiesSubSectionContainer">
          <h3 className="comSubSectionTitle modalitiesSubSectionTitle">5 Point Massage Session</h3>
