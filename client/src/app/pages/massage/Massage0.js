...
class Massage extends Component {
  render() {
    ...
    <div id="massageContainer" className="comContainer">
      ...
      <div className="comSubSectionBoxContainer">
        <div className="comSubSectionBox massageSubSectionBox">
          <h3 className="comSubSectionBoxTitle massageSubSectionBoxTitle">Swedish Relaxation</h3>
        ...
        <div className="comSubSectionBox massageSubSectionBox">
          <h3 className="comSubSectionBoxTitle massageSubSectionBoxTitle">Hot Stone Massage</h3>
        ...
        <div className="comSubSectionBox massageSubSectionBox">
          <h3 className="comSubSectionBoxTitle massageSubSectionBoxTitle">Deep Tissue</h3>
        ...
        <div className="comSubSectionBox massageSubSectionBox">
          <h3 className="comSubSectionBoxTitle massageSubSectionBoxTitle">Prenatal</h3>
        ...
        <div className="comSubSectionBox massageSubSectionBox">
          <h3 className="comSubSectionBoxTitle massageSubSectionBoxTitle">Trigger Point</h3>
